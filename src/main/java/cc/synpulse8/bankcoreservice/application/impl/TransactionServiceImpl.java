...
public class TransactionServiceImpl implements TransactionService {
    ...
    @Override
    public RestfulResponse<Page<TransactionEntity>> getTransactionList(TransactionPageRequest transactionPageRequest) {

        return new RestfulResponse<>(transactionInfoService.getTransactionList(transactionPageRequest));
    }
}
